...
while getopts "s:m:f:w:g:v:h" OPTION; do
    case $OPTION in
        s)
...
VG_WDL_WORKFLOW_DIR="/data/${USER}/vg_wdl/workflows"
SIB_BAM_FILE_PARAMS=""
...
echo "source /data/${USER}/vg_wdl_testrun/miniwdl_venv/bin/activate" >> ${COHORT_WORKFLOW_DIR}/${PROBAND_SAMPLE_NAME}_cohort_2nd_iter_pedigree_call.part_5.sh
