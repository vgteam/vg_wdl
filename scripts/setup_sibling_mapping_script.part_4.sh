...
while getopts "s:w:g:v:h" OPTION; do
    case $OPTION in
        s)
...
echo "source /data/${USER}/vg_wdl_testrun/miniwdl_venv/bin/activate" >> ${COHORT_WORKFLOW_DIR}/${PROBAND_SAMPLE_NAME}_cohort_2nd_iter_sibling_map.part_4.sh
