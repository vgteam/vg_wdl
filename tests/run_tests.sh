...
miniwdl cromwell --debug --no-quant-check -d "$ORIG_CWD/vg_wdl_tests_ABOlocus_small" \
...
miniwdl cromwell --debug --no-quant-check -d "$ORIG_CWD/vg_wdl_tests_ABOlocus_pedigree" \
