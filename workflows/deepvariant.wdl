...
workflow DeepVariant {
    ...
    parameter_meta {
        ...
        DV_USE_MODEL_CHANNELS: "Flag to use DeepVariant's model to infer channels. Must be true if providing a DV 1.7+ Docker image, and false if providing an older one."
    ...
    scatter (bam_and_index_for_path in zip(splitBAMbyPath.bam_contig_files, splitBAMbyPath.bam_contig_files_index)) {
        ...
        call dv.runDeepVariantMakeExamples {
            input:
                ...
                in_use_model_channels=DV_USE_MODEL_CHANNELS,
